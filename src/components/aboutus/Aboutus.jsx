  ...
  return (
    <div className="scholofind__about">
      ...
      <div className="scholofind__about-content1">
        <p>
          In today&#x27;s world, education has become one of the most essential
          and expensive assets. Most high school pass outs look for financial
          assistance to pursue the career of their dreams that requires several
          years of education. In such a scenario, scholarships come up as the
          most desired form of financial aid. This is because, unlike
          educational loans, you don&#x27;t have to repay scholarships. If you
          are deserving, you can get scholarships on merit basis. This makes
          scholarships prestigious and also pays for your degree.
        </p>
